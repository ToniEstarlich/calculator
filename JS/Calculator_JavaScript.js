...
const Calculator = {
    ...
    Display_Value: '0',
    //This will hold the first operand for any expressions,we setr it to null for now
    First_Operand: null,
...
function Input_Decimal(dot) {
    ...
    if (!Calculator.Display_Value.includes(dot)) {
        // we arre saying that if the Display_Value does not contain a decimal point
